...
const Data = [
  ...
  {
    blogimage: phone,
    linked:"https://medrectech.com/solution/mobile-solution",
    blogtitle : "MOBILITY SOLUTIONS",
    blogdesc: "We provide end-to-end services for iOS and Android mobile applications. You can get assistance from us in developing software and apps for mobile devices.",
  },

  {
    scardimage: web,
    linked:"https://en.wikipedia.org/wiki/Web_application",
...

  {
    ...
    linked:"https://en.wikipedia.org/wiki/E-commerce",
  ...
  {
    scardimage: ui,
    linked:"https://en.wikipedia.org/wiki/User_interface",
...

  {
    ...
    linked:"https://en.wikipedia.org/wiki/Web_design",
...

  {
    ...
    linked:"https://en.wikipedia.org/wiki/Enterprise_portal",
  ...
  {
    scardimage: bio,
    linked:"https://www.techtarget.com/searchcio/definition/SMAC-social-mobile-analytics-and-cloud",
  ...
  {
    scardimage:smac,
    linked:"https://en.wikipedia.org/wiki/Bioinformatics",
  ...
  {
    scardimage:ecommerce,
    linked:"https://en.wikipedia.org/wiki/Digital_marketing",
